@component('component.card', ['title' => __('Text Analyzing')])
    ...
    @if(isset($response))
        ...
        <div class="mt-5 mb-3" style="max-height: 600px; overflow-y: auto;">
            ...
            <table id="totalTable" class="table table-bordered table-striped dataTable dtr-inline">
                <thead>
                <tr>
                    <th class="w-25">Слово <i class="fa fa-sort"></i></th>
                    <th>Плотность <i class="fa fa-sort"></i></th>
                    <th>Общая зона <i class="fa fa-sort"></i></th>
                    <th>Зона текста <i class="fa fa-sort"></i></th>
                    <th>Зона ссылок <i class="fa fa-sort"></i></th>
                </tr>
                </thead>
                <tbody>
                @foreach($response['totalWords'] as $word)
                    <tr>
                        <td data-order="{{ $word['text'] }}" class="w-25 unique-word">
                            {{ $word['text'] }}
                            <span class="text-muted" style="display: none">
                                @isset($word['wordForms']['inLink'])
                                    <p class="pt-2">Зона ссылок:</p>
    ...
    @slot('js')
        ...
        <script defer src="{{ asset('plugins/text-analyzer/js/switch-my-list.js') }}"></script>
        <script defer src="{{ asset('plugins/text-analyzer/js/render-graph.js') }}"></script>
        <script>
        ...
        <script>
            ...
            (function (l) {
                ...
                function Fb(a) {
                    var b, c, d = a.nTHead, e = a.nTFoot, h = 0 === l("th, td", d).length, f = a.oClasses,
                        g = a.aoColumns;
                    h && (c = l("<tr/>").appendTo(d));
                    var k = 0;
                ...
                function ja(a, b) {
                    ...
                    if (-1 !== l.inArray(!1, c)) V(a, !1);
                        ...
                        c = [];
                        var d = 0, e = a.asStripeClasses, h = e.length, f = a.oLanguage, g = a.iInitDisplayStart,
                            k = "ssp" == Q(a),
                            m = a.aiDisplay;
                        a.bDrawing = !0;
                ...
                function Pb(a) {
                    var b = a.aoColumns, c = b.length, d = a.oFeatures, e = a.oPreviousSearch, h = a.aoPreSearchCols,
                        f = [],
                        g = pa(a);
                ...
                function Ha(a) {
                    ...
                    b = b.iBarWidth;
                    var h = l(a.nScrollHead), f = h[0].style, g = h.children("div"), k = g[0].style,
                        m = g.children("table");
                    g = a.nScrollBody;
                    var n = l(g), p =
                            g.style, t = l(a.nScrollFoot).children("div"), v = t.children("table"), x = l(a.nTHead),
                        w = l(a.nTable),
                        r = w[0], C = r.style, G = a.nTFoot ? l(a.nTFoot) : null, aa = a.oBrowser,
                ...
                function Ya(a) {
                    var b = a.nTable, c = a.aoColumns, d = a.oScroll, e = d.sY, h = d.sX, f = d.sXInner, g = c.length,
                        k = Ia(a, "bVisible"), m = l("th", a.nTHead), n = b.getAttribute("width"), p = b.parentNode,
                        t = !1, v,
                        x = a.oBrowser;
                    d = x.bScrollOversize;
                ...
                var Cc = function (a, b, c) {
                    var d = a.aoData, e = Va(a, c), h = kc(Ea(d, e, "anCells")), f = l(lc([], h)), g,
                        k = a.aoColumns.length, m, n,
                        p, t, v, x;
                ...
                u.defaults = {
                    ...
                    oLanguage: {
                        ...
                        oPaginate: {
                            ...
                            sNext: "{{ __('Next') }}", sPrevious: "{{ __('Previous') }}"
                        },
