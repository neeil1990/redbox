@component('component.card', ['title' => __('HTML editor')])
    ...
    <div class="d-flex mt-3 mb-3">
        <a class="btn btn-secondary mr-2 click_tracking" data-click="Create a project"
           href="{{ route('create.project') }}">
            {{__('Create a project')}}
        </a>
        @if(count($projects) != 0)
            <a class="btn btn-default btn-flat click_tracking" data-click="Add text to the project"
               href="{{ route('create.description') }}">
                            ...
                            <td class="d-flex justify-content-between">
                                ...
                                <div>
                                    <a href="{{ route('edit.project', $project->id) }}"
                                       class="fa fa-edit mr-2 click_tracking" data-click="Edit project">
                                    </a>
                                                ...
                                                <td class="d-flex justify-content-between pr-3 text-wrap">
                                                    ...
                                                    <div>
                                                        <a href="{{ route('edit.description', $description->id) }}">
                                                            <i class="fa fa-edit click_tracking"
                                                               data-click="Edit description"></i>
                                                        </a>
