...
Route::get('/test', function () {
    $classic = [
        ...
        "save" => true,
        "request" => [
            "_token" => "0ZIJc20a0a4QJmdrF4XwUXFHCxbt6EtRyG36vxkg",
            "save" => "1",
            "region" => "1",
            "phrases" => "тонометр цена
тонометр купить
купить тонометр цена
тонометр давления купить
тонометр артериального давления
...
офтальмоскоп электрический купить",
            ...
            "searchRelevance" => "false",
            "mode" => "classic",
            "progressId" => "8eca8732f717ac5f693c078362dc0b9e",
            "engineVersion" => "1501",
            "count" => 40
        ],
        "newCluster" => null,
    ...
    $prof = [
        ...
        "request" => [
            "_token" => "0ZIJc20a0a4QJmdrF4XwUXFHCxbt6EtRyG36vxkg",
            "save" => "1",
            "progressId" => "16815394b5c4ee4fb466b988932d49e6",
            "region" => "213",
            "count" => 40,
            "phrases" => "тонометр цена
тонометр купить
...
офтальмоскоп электрический купить",
            ...
            "mode" => "professional",
            "brutForceCount" => "3",
            "reductionRatio" => "pre-hard",
            "ignoredWords" => "цена
купить
хлеб",
            "ignoredDomains" => "ozon.ru
yandex.ru
wildberries.ru
apteka.ru
sbermegamarket.ru
