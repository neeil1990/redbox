...
* [#2756](https://github.com/ckeditor/ckeditor4/issues/2756): Fixed: The [Auto Link](https://ckeditor.com/cke4/addon/autolink) plugin causes an error when typing in the [source Editing clusters](https://ckeditor.com/docs/ckeditor4/latest/guide/dev_sourcearea.html).
