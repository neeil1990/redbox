...
(function (d) {
    ...
    }) : "object" === typeof exports ? module.exports = function (q, l) {
        q || (q = window);
        if (!l || !l.fn.dataTable) l = require("datatables.net")(q, l).$;
        return d(l, q, q.document)
    ...
    function D(a, b, c, f) {
        ...
        b.message ===
        h && ("remove" === c ? (a = a.i18n[c].confirm, b.message = 1 !== f ? a._.replace(/%d/, f) : a["1"]) : b.message = "");
        return b
    }

    var u = d.fn.dataTable;
    if (!u || !u.versionCheck || !u.versionCheck("1.10.7")) throw"Editor requires DataTables 1.10.7 or newer";
    var e = function (a) {
    ...
    e.Field = function (a, b, c) {
        var f = this, g = c.i18n.multi, a = d.extend(!0, {}, e.Field.defaults, a);
        if (!e.fieldTypes[a.type]) throw"Error adding field - unknown field type " + a.type;
        this.s = d.extend({}, e.Field.settings, {
        ...
        this.valFromData = function (b) {
            return k._fnGetObjectDataFn(a.data)(b,
                "editor")
        };
        this.valToData = k._fnSetObjectDataFn(a.data);
        var j = d('<div class="' + b.wrapper + " " + b.typePrefix + a.type + " " + b.namePrefix + a.name + " " + a.className + '">' +
            '<label data-dte-e="label" class="' + b.label + '" for="' + a.id + '">' + a.label + '<div data-dte-e="msg-label" class="' + b["msg-label"] + '">' + a.labelInfo + '</div></label>' +
            '<div data-dte-e="input" class="' + b.input + '"> <div data-dte-e="multi-value" class="' + b.multiValue + '">' + g.title + '<span data-dte-e="multi-info" class="' + b.multiInfo + '">' + g.info + '</span></div> <div data-dte-e="input-control" class="' + b.inputControl + '"/>' +
            '<div data-dte-e="msg-multi" class="' + b.multiRestore + '">' + g.restore + '</div><div data-dte-e="msg-error" class="' + b["msg-error"] + '"></div><div data-dte-e="msg-message" class="' + b["msg-message"] + '">' + a.message + '</div><div data-dte-e="msg-info" class="' + b["msg-info"] + '">' + a.fieldInfo + "</div></div></div>"),
            c = this._typeFn("create", a);
        null !== c ? w("input-control", j).prepend(c) : j.css("display", "none");
        this.dom = d.extend(!0, {}, e.Field.models.dom, {
            container: j,
    ...
    e.Field.prototype = {
        def: function (a) {
            ...
            return this.s.type.input ? this._typeFn("input") : d("input, select, textarea",
                this.dom.container)
        }, focus: function () {
            ...
            return this._msg(this.dom.labelInfo,
                a)
        }, message: function (a, b) {
            return this._msg(this.dom.fieldMessage, a, b)
        }, multiGet: function (a) {
            var b = this.s.multiValues, c = this.s.multiIds;
            if (a === h) for (var a = {}, f = 0; f < c.length; f++) a[c[f]] = this.isMultiValue() ? b[c[f]] : this.val(); else a = this.isMultiValue() ? b[a] : this.val();
            return a
        }, multiSet: function (a, b) {
            var c = this.s.multiValues, f = this.s.multiIds;
            b === h && (b = a, a = h);
            var g = function (a, b) {
            ...
            if (c === h || !0 === c) if (d.isArray(a)) for (var c = 0, f = a.length; c < f; c++) a[c] = b(a[c]); else a = b(a);
            this._typeFn("set",
                a);
            this._multiValueCheck();
            return this
            ...
            if (b === h) return a.html();
            if ("function" === typeof b) var f = this.s.host, b = b(f, new u.Api(f.s.table));
            a.parent().is(":visible") ? (a.html(b), b ? a.slideDown(c) : a.slideUp(c)) : (a.html(b || "").css("display", b ? "block" : "none"), c && c());
            return this
        }, _multiValueCheck: function () {
            var a, b = this.s.multiIds, c = this.s.multiValues, f = this.s.multiValue,
                d = this.s.opts.multiEditable, k, j = !1;
            ...
            j && f || !d && f ? (this.dom.inputControl.css({display: "none"}), this.dom.multi.css({display: "block"})) : (this.dom.inputControl.css({display: "block"}), this.dom.multi.css({display: "none"}), f && this.val(a));
    ...
    e.Field.models.dom = {
        container: null, label: null, labelInfo: null, fieldInfo: null,
        fieldError: null, fieldMessage: null
    };
    e.models = {};
    ...
    e.display = {};
    var t = jQuery, p;
    e.display.lightbox = t.extend(!0, {}, e.models.displayController, {
        init: function () {
            p._init();
            return p
        }, open: function (a, b, c) {
            if (p._shown) c && c(); else {
                p._dte = a;
                a = p._dom.content;
                a.children().detach();
                a.append(b).append(p._dom.close);
                p._shown = true;
                p._show(c)
            }
        }, close: function (a, b) {
            ...
            return p._dom.wrapper[0]
        }, _init: function () {
            if (!p._ready) {
                var a = p._dom;
                a.content = t("div.DTED_Lightbox_Content", p._dom.wrapper);
                a.wrapper.css("opacity", 0);
                a.background.css("opacity", 0)
            }
        }, _show: function (a) {
            var b = p._dom;
            q.orientation !== h && t("body").addClass("DTED_Lightbox_Mobile");
            b.content.css("height", "auto");
            b.wrapper.css({top: -p.conf.offsetAni});
            t("body").append(p._dom.background).append(p._dom.wrapper);
            p._heightCalc();
            b.wrapper.stop().animate({
                opacity: 1,
                top: 0
            }, a);
            b.background.stop().animate({opacity: 1});
            setTimeout(function () {
            ...
            t("div.DTED_Lightbox_Content_Wrapper", b.wrapper).bind("click.DTED_Lightbox", function (a) {
                t(a.target).hasClass("DTED_Lightbox_Content_Wrapper") && p._dte.background()
            });
            t(q).bind("resize.DTED_Lightbox", function () {
                p._heightCalc()
            });
            p._scrollTop = t("body").scrollTop();
            if (q.orientation !== h) {
                a = t("body").children().not(b.background).not(b.wrapper);
                t("body").append('<div class="DTED_Lightbox_Shown"/>');
                t("div.DTED_Lightbox_Shown").append(a)
            }
        }, _heightCalc: function () {
            var a = p._dom,
                b = t(q).height() - p.conf.windowPadding * 2 - t("div.DTE_Header", a.wrapper).outerHeight() - t("div.DTE_Footer", a.wrapper).outerHeight();
            ...
            t("body").removeClass("DTED_Lightbox_Mobile").scrollTop(p._scrollTop);
            b.wrapper.stop().animate({opacity: 0, top: p.conf.offsetAni}, function () {
                t(this).detach();
                a()
            });
            b.background.stop().animate({opacity: 0}, function () {
                t(this).detach()
            });
            ...
            t(q).unbind("resize.DTED_Lightbox")
        }, _dte: null, _ready: !1, _shown: !1, _dom: {
            wrapper: t('<div class="DTED DTED_Lightbox_Wrapper"><div class="DTED_Lightbox_Container"><div class="DTED_Lightbox_Content_Wrapper"><div class="DTED_Lightbox_Content"></div></div></div></div>'),
            background: t('<div class="DTED_Lightbox_Background"><div/></div>'),
            close: t('<div class="DTED_Lightbox_Close"></div>'),
            content: null
        }
    });
    p = e.display.lightbox;
    p.conf = {offsetAni: 25, windowPadding: 25};
    var m = jQuery, i;
    e.display.envelope = m.extend(!0, {}, e.models.displayController, {
        init: function (a) {
            i._dte = a;
            i._init();
            return i
        ...
        open: function (a, b, c) {
            i._dte = a;
            m(i._dom.content).children().detach();
        ...
        _init: function () {
            if (!i._ready) {
                i._dom.content = m("div.DTED_Envelope_Container", i._dom.wrapper)[0];
                l.body.appendChild(i._dom.background);
                l.body.appendChild(i._dom.wrapper);
                i._dom.background.style.visbility = "hidden";
                i._dom.background.style.display = "block";
                i._cssBackgroundOpacity = m(i._dom.background).css("opacity");
        ...
        _show: function (a) {
            ...
            i._dom.content.style.height =
                "auto";
            var b = i._dom.wrapper.style;
            b.opacity = 0;
            b.display = "block";
            var c = i._findAttachRow(), f = i._heightCalc(), d = c.offsetWidth;
            b.display = "none";
            b.opacity = 1;
            i._dom.wrapper.style.width = d + "px";
            i._dom.wrapper.style.marginLeft = -(d / 2) + "px";
            i._dom.wrapper.style.top = m(c).offset().top + c.offsetHeight + "px";
            i._dom.content.style.top = -1 * f - 20 + "px";
            i._dom.background.style.opacity = 0;
            i._dom.background.style.display = "block";
            m(i._dom.background).animate({opacity: i._cssBackgroundOpacity}, "normal");
            m(i._dom.wrapper).fadeIn();
            i.conf.windowScroll ? m("html,body").animate({scrollTop: m(c).offset().top + c.offsetHeight - i.conf.windowPadding}, function () {
                m(i._dom.content).animate({top: 0}, 600, a)
            }) : m(i._dom.content).animate({top: 0}, 600, a);
            m(i._dom.close).bind("click.DTED_Envelope", function () {
                i._dte.close()
            });
            m(i._dom.background).bind("click.DTED_Envelope", function () {
                i._dte.background()
            });
            m("div.DTED_Lightbox_Content_Wrapper", i._dom.wrapper).bind("click.DTED_Envelope", function (a) {
                m(a.target).hasClass("DTED_Envelope_Content_Wrapper") &&
                i._dte.background()
            });
            m(q).bind("resize.DTED_Envelope", function () {
                i._heightCalc()
            })
        },
        _heightCalc: function () {
            i.conf.heightCalc ? i.conf.heightCalc(i._dom.wrapper) : m(i._dom.content).children().height();
            var a = m(q).height() - i.conf.windowPadding * 2 - m("div.DTE_Header", i._dom.wrapper).outerHeight() - m("div.DTE_Footer", i._dom.wrapper).outerHeight();
            m("div.DTE_Body_Content", i._dom.wrapper).css("maxHeight", a);
            return m(i._dte.dom.wrapper).outerHeight()
        },
        _hide: function (a) {
            a || (a = function () {
            });
            m(i._dom.content).animate({
                top: -(i._dom.content.offsetHeight +
                    50)
            }, 600, function () {
                m([i._dom.wrapper, i._dom.background]).fadeOut("normal", a)
            });
            m(i._dom.close).unbind("click.DTED_Lightbox");
            m(i._dom.background).unbind("click.DTED_Lightbox");
            m("div.DTED_Lightbox_Content_Wrapper", i._dom.wrapper).unbind("click.DTED_Lightbox");
            m(q).unbind("resize.DTED_Lightbox")
        },
        _findAttachRow: function () {
            var a = m(i._dte.s.table).DataTable();
        ...
        _dom: {
            wrapper: m('<div class="DTED DTED_Envelope_Wrapper"><div class="DTED_Envelope_Shadow"></div><div class="DTED_Envelope_Container"></div></div>')[0],
            background: m('<div class="DTED_Envelope_Background"><div/></div>')[0],
            close: m('<div class="DTED_Envelope_Close">&times;</div>')[0],
            content: null
        }
    });
    i = e.display.envelope;
    i.conf = {windowPadding: 50, heightCalc: null, attach: "row", windowScroll: !0};
    e.prototype.add = function (a, b) {
        if (d.isArray(a)) for (var c = 0, f = a.length; c < f; c++) this.add(a[c]);
        else {
            c = a.name;
            if (c === h) throw"Error adding field. The field requires a `name` option";
            ...
            b === h ? this.s.order.push(c) : null === b ? this.s.order.unshift(c) : (f = d.inArray(b, this.s.order), this.s.order.splice(f + 1, 0, c))
        }
    ...
    e.prototype.bubble = function (a, b, c, f) {
        ...
        d.isPlainObject(b) ? (f = b, b = h, c = !0) : "boolean" === typeof b && (c = b, f = b = h);
        d.isPlainObject(c) && (f = c, c = !0);
        c === h && (c = !0);
        var f = d.extend({}, this.s.formOptions.bubble, f), k = this._dataSource("individual", a, b);
        this._edit(a, k, "bubble");
        if (!this._preopen("bubble")) return this;
        var j = this._formOptions(f);
        d(q).on("resize." + j, function () {
            g.bubblePosition()
        });
        var e = [];
        this.s.bubbleNodes = e.concat.apply(e, A(k, "attach"));
        e = this.classes.bubble;
        k = d('<div class="' + e.bg + '"><div/></div>');
        e = d('<div class="' + e.wrapper + '"><div class="' + e.liner + '"><div class="' + e.table + '"><div class="' + e.close + '" /><div class="DTE_Processing_Indicator"><span></div></div></div><div class="' + e.pointer + '" /></div>');
        c && (e.appendTo("body"), k.appendTo("body"));
        var c = e.children().eq(0), r = c.children(), y = r.children();
        c.append(this.dom.formError);
        r.prepend(this.dom.form);
        f.message && c.prepend(this.dom.formInfo);
        f.title && c.prepend(this.dom.header);
        f.buttons && r.append(this.dom.buttons);
        var s = d().add(e).add(k);
        this._closeReg(function () {
            s.animate({opacity: 0}, function () {
                s.detach();
                d(q).off("resize." + j);
                g._clearDynamicInfo()
            })
    ...
    e.prototype.bubblePosition =
        function () {
            var a = d("div.DTE_Bubble"), b = d("div.DTE_Bubble_Liner"), c = this.s.bubbleNodes, f = 0, g = 0, k = 0,
                e = 0;
            d.each(c, function (a, b) {
                var c = d(b).offset(), b = d(b).get(0);
                f += c.top;
                g += c.left;
                k += c.left + b.offsetWidth;
                e += c.top + b.offsetHeight
            });
            var f = f / c.length, g = g / c.length, k = k / c.length, e = e / c.length, c = f, o = (g + k) / 2,
                r = b.outerWidth(), y = o - r / 2, r = y + r, h = d(q).width();
            a.css({top: c, left: o});
            b.length && 0 > b.offset().top ? a.css("top", e).addClass("below") : a.removeClass("below");
            r + 15 > h ? b.css("left", 15 > y ? -(y - 15) : -(r - h + 15)) : b.css("left",
                15 > y ? -(y - 15) : 0);
            return this
        };
    e.prototype.buttons = function (a) {
        ...
        d.each(a, function (a, f) {
            ...
            d("<button/>", {"class": b.classes.form.button + (f.className ? " " + f.className : "")}).html("function" === typeof f.label ? f.label(b) : f.label || "").attr("tabindex", f.tabIndex !== h ? f.tabIndex : 0).on("keyup", function (a) {
                13 ===
                a.keyCode && f.fn && f.fn.call(b)
    ...
    e.prototype.create = function (a,
                                   b, c, f) {
        var g = this, k = this.s.fields, e = 1;
        if (this._tidy(function () {
            g.create(a, b, c, f)
        })) return this;
        "number" === typeof a && (e = a, a = b, b = c);
        this.s.editFields = {};
        for (var o = 0; o < e; o++) this.s.editFields[o] = {fields: this.s.fields};
    ...
    e.prototype.dependent = function (a, b, c) {
        if (d.isArray(a)) {
            for (var f = 0, g = a.length; f < g; f++) this.dependent(a[f], b, c);
            return this
        }
        var k = this, e = this.field(a), o = {type: "POST", dataType: "json"},
            c = d.extend({event: "change", data: null, preUpdate: null, postUpdate: null}, c), r = function (a) {
        ...
        d(e.node()).on(c.event, function (a) {
            if (-1 !== d.inArray(a.target, e.input().toArray())) {
                a = {};
                a.rows = k.s.editFields ? A(k.s.editFields, "data") : null;
                ...
                "function" === typeof b ? (a = b(e.val(), a, r)) && r(a) : (d.isPlainObject(b) ? d.extend(o, b) : o.url = b, d.ajax(d.extend(o, {
                    url: b,
                    data: a,
                    success: r
                })))
    ...
    e.prototype.inError = function (a) {
        ...
        for (var b = this.s.fields, a = this._fieldNames(a), c = 0, f = a.length; c < f; c++) if (b[a[c]].inError()) return !0;
        return !1
    };
    e.prototype.inline = function (a, b, c) {
        var f = this;
        d.isPlainObject(b) && (c = b, b = h);
        var c = d.extend({}, this.s.formOptions.inline, c), g = this._dataSource("individual", a, b), k, e, o = 0, r,
            i = !1, s = this.classes.inline;
        d.each(g, function (a, b) {
            if (o > 0) throw"Cannot edit more than one row inline at a time";
            k = d(b.attach[0]);
            r = 0;
            d.each(b.displayFields, function (a, b) {
                if (r > 0) throw"Cannot edit more than one field inline at a time";
                e = b;
                r++
            });
            o++
        ...
        k.append(d('<div class="' + s.wrapper + '"><div class="' + s.liner + '"><div class="DTE_Processing_Indicator"><span/></div></div><div class="' + s.buttons + '"/></div>'));
        k.find("div." + s.liner.replace(/ /g, ".")).append(e.node()).append(this.dom.formError);
        c.buttons && k.find("div." + s.buttons.replace(/ /g,
        ...
        setTimeout(function () {
            if (!i) d(l).on("click" + M, function (a) {
    ...
    e.prototype.remove = function (a, b, c, f, g) {
        ...
        a.length === h && (a = [a]);
        var e = this._crudArgs(b, c, f, g), o = this._dataSource("fields", a);
        this.s.action = "remove";
        this.s.modifier = a;
        this.s.editFields = o;
        this.dom.form.style.display = "none";
        this._actionClass();
        this._event("initRemove", [A(o, "node"), A(o, "data"), a]);
        this._event("initMultiRemove", [o, a]);
        this._assembleMain();
        this._formOptions(e.opts);
        e.maybeOpen();
        e = this.s.editOpts;
        null !== e.focus &&
        d("button", this.dom.buttons).eq(e.focus).focus();
        return this
    };
    ...
    e.prototype.submit = function (a, b, c, f) {
        var g = this, e = this.s.fields, j = [], o = 0, r = !1;
        if (this.s.processing || !this.s.action) return this;
        this._processing(!0);
        var h = function () {
            j.length !==
            o || r || (r = !0, g._submit(a, b, c, f))
        };
        this.error();
    ...
    e.prototype.title = function (a) {
        ...
        if (a === h) return b.html();
        "function" === typeof a && (a = a(this, new u.Api(this.s.table)));
        b.html(a);
        return this
    };
    ...
    e.pairs = function (a, b, c) {
        var f, g, e, b = d.extend({label: "label", value: "value"}, b);
        if (d.isArray(a)) {
            f =
                0;
            for (g = a.length; f < g; f++) e = a[f], d.isPlainObject(e) ? c(e[b.value] === h ? e[b.label] : e[b.value], e[b.label], f) : c(e, e, f)
        } else f = 0, d.each(a, function (a, b) {
            c(b, a, f);
            f++
        })
    };
    ...
    e.upload = function (a, b, c, f, g) {
        ...
        k.onload = function () {
            ...
            d.ajax(d.extend({}, h, {
                type: "post", data: r, dataType: "json", contentType: !1, processData: !1, xhr: function () {
                    var a = d.ajaxSettings.xhr();
                    a.upload && (a.upload.onprogress = function (a) {
                        a.lengthComputable && (a = (100 * (a.loaded / a.total)).toFixed(0) + "%", f(b, 1 === c.length ? a : j + ":" + c.length + " " + a))
                    },
                    ...
                    if (f.fieldErrors && f.fieldErrors.length) for (var f = f.fieldErrors, r = 0, h = f.length; r < h; r++) a.error(f[r].name, f[r].status); else f.error ? a.error(f.error) : !f.upload || !f.upload.id ? a.error(b.name, "A server error occurred while uploading the file") : (f.files && d.each(f.files, function (a, b) {
                        d.extend(e.files[a], b)
                    }), o.push(f.upload.id), j < c.length - 1 ? (j++, k.readAsDataURL(c[j])) : (g.call(a,
                        o), i && a.submit()))
                }, error: function (c) {
    ...
    e.prototype._constructor = function (a) {
        ...
        this.s = d.extend(!0, {}, e.models.settings, {
            ...
            template: a.template ?
                d(a.template).detach() : null
        });
        this.classes = d.extend(!0, {}, e.classes);
        this.i18n = a.i18n;
        e.models.settings.unique++;
        var b = this, c = this.classes;
        this.dom = {
            wrapper: d('<div class="' + c.wrapper + '"><div data-dte-e="processing" class="' + c.processing.indicator + '"><span/></div><div data-dte-e="body" class="' + c.body.wrapper + '"><div data-dte-e="body_content" class="' + c.body.content + '"/></div><div data-dte-e="foot" class="' + c.footer.wrapper + '"><div class="' + c.footer.content + '"/></div></div>')[0],
            form: d('<form data-dte-e="form" class="' +
                c.form.tag + '"><div data-dte-e="form_content" class="' + c.form.content + '"/></form>')[0],
        ...
        if (d.fn.dataTable.TableTools) {
            var f = d.fn.dataTable.TableTools.BUTTONS, g = this.i18n;
            d.each(["create",
                "edit", "remove"], function (a, b) {
        ...
        d(l).on("init.dt.dte" + this.s.unique, function (a, c) {
            b.s.table && c.nTable === d(b.s.table).get(0) && (c._editor =
                b)
    ...
    e.prototype._ajax = function (a, b, c) {
        var f,
            g = {
                type: "POST", dataType: "json", data: null, error: [function (a, b, c) {
                    f = c
                }], complete: [function (a, g) {
                    var e = null;
                    if (204 === a.status) e = {}; else try {
                        e = d.parseJSON(a.responseText)
                    } catch (k) {
                    }
        ...
        var j = this.s.ajax || this.s.ajaxUrl,
            o = "edit" === e || "remove" === e ? A(this.s.editFields, "idSrc") : null;
        d.isArray(o) && (o = o.join(","));
    ...
    e.prototype._crudArgs = function (a, b, c, f) {
        var g = this, e, j, o;
        d.isPlainObject(a) || ("boolean" === typeof a ? (o = a, a = b) : (e = a, j = b, o = c, a = f));
        o === h && (o = !0);
        e && g.title(e);
        j && g.buttons(j);
        return {
            opts: d.extend({}, this.s.formOptions.main, a), maybeOpen: function () {
                o && g.open()
            }
        }
    };
    ...
    e.prototype._displayReorder = function (a) {
        var b = d(this.dom.formContent), c = this.s.fields, f = this.s.order, g = this.s.template,
            k = this.s.mode || "main";
        a ? this.s.includeFields =
            a : a = this.s.includeFields;
        b.children().detach();
        d.each(f, function (f, h) {
            var r = h instanceof e.Field ? h.name() : h;
            -1 !== d.inArray(r, a) && (g && "main" === k ? g.find('editor-field[name="' + r + '"]').after(c[r].node()) : b.append(c[r].node()))
        });
    ...
    e.prototype._edit = function (a, b, c) {
        ...
        for (var f = this.order().slice(), j = f.length - 1; 0 <= j; j--) -1 === d.inArray(f[j].toString(), g) && f.splice(j, 1);
        this._displayReorder(f);
        this.s.editData = d.extend(!0, {}, this.multiGet());
        this._event("initEdit", [A(b, "node")[0], A(b, "data")[0], a, c]);
        this._event("initMultiEdit", [b, a, c])
    };
    e.prototype._event =
        function (a, b) {
            b || (b = []);
            if (d.isArray(a)) for (var c = 0, f = a.length; c < f; c++) this._event(a[c], b); else return c = d.Event(a), d(this).triggerHandler(c, b), c.result
        };
    e.prototype._eventName = function (a) {
        for (var b = a.split(" "), c = 0, f = b.length; c < f; c++) {
            var a = b[c], d = a.match(/^on([A-Z])/);
    ...
    e.prototype._formOptions = function (a) {
        ...
        d(l).on("keydown" + f, function (c) {
            var f = d(l.activeElement);
            if (c.keyCode === 13 && b.s.displayed) {
                var e =
                    b._fieldFromNode(f);
                if (typeof e.canReturnSubmit === "function" && e.canReturnSubmit(f)) if (a.onReturn === "submit") {
                    c.preventDefault();
                    b.submit()
                ...
                c.preventDefault();
                if (typeof a.onEsc === "function") a.onEsc(b); else a.onEsc === "blur" ? b.blur() : a.onEsc === "close" ? b.close() : a.onEsc === "submit" && b.submit()
    ...
    e.prototype._legacyAjax = function (a, b, c) {
        if (this.s.legacyAjax) if ("send" === a) if ("create" === b || "edit" === b) {
            ...
            d.each(c.data, function (a) {
                if (f !== h) throw"Editor: Multi-row editing is not supported by the legacy Ajax data format";
                f = a
            });
            c.data = c.data[f];
            "edit" === b && (c.id = f)
    ...
    e.prototype._optionsUpdate = function (a) {
        var b = this;
        a.options &&
        d.each(this.s.fields, function (c) {
            if (a.options[c] !== h) {
                var f = b.field(c);
    ...
    e.prototype._message = function (a, b) {
        "function" === typeof b && (b = b(this, new u.Api(this.s.table)));
        a = d(a);
    ...
    e.prototype._multiInfo = function () {
        ...
        if (b) for (var d = 0, e = b.length; d < e; d++) {
            ...
            f.isMultiValue() && j && c ? (f = !0, c = !1) : f = f.isMultiValue() && !j ? !0 : !1;
            a[b[d]].multiInfoShown(f)
        }
    };
    e.prototype._postopen = function (a) {
        var b = this, c = this.s.displayController.captureFocus;
        c === h && (c = !0);
        ...
        if (c && ("main" === a || "bubble" === a)) d("body").on("focus.editor-focus", function () {
            0 === d(l.activeElement).parents(".DTE").length && 0 === d(l.activeElement).parents(".DTED").length &&
            b.s.setFocus && b.s.setFocus.focus()
        });
        this._multiInfo();
    ...
    e.prototype._preopen = function (a) {
        if (!1 === this._event("preOpen", [a, this.s.action])) return this._clearDynamicInfo(), !1;
        this.s.displayed = a;
        return !0
    };
    ...
    e.prototype._submit = function (a, b, c, f) {
        var g = this, e = !1, j = {}, o = {}, i = u.ext.oApi._fnSetObjectDataFn, y =
                this.s.fields, s = this.s.action, p = this.s.editCount, m = this.s.editFields, q = this.s.editData,
            n = this.s.editOpts, t = n.submit, l = {action: this.s.action, data: {}}, v;
        this.s.dbTable && (l.table = this.s.dbTable);
        if ("create" === s || "edit" === s) if (d.each(m, function (a, b) {
            var c = {}, f = {};
            d.each(y, function (g, j) {
                if (b.fields[g]) {
                    var h = j.multiGet(a), o = i(g),
                        l = d.isArray(h) && g.indexOf("[]") !== -1 ? i(g.replace(/\[.*$/, "") + "-many-count") : null;
                    o(c, h);
                    l && l(c, h.length);
                    if (s === "edit" && (!q[g] || !L(h, q[g][a]))) {
                        o(f, h);
                        e = true;
                        l && l(f, h.length)
                    }
            ...
            d.isEmptyObject(f) || (o[a] = f)
        }), "create" === s || "all" === t || "allIfChanged" === t && e) l.data = j; else if ("changed" === t && e) l.data = o; else {
            this.s.action = null;
            if ("close" === n.onComplete && (f === h || f)) this._close(!1); else if ("function" === typeof n.onComplete) n.onComplete(this);
            a && a.call(this);
            this._processing(!1);
            this._event("submitComplete");
            return
        } else "remove" === s && d.each(m, function (a, b) {
            l.data[a] = b.data
        });
        this._legacyAjax("send", s, l);
        v = d.extend(!0, {}, l);
        c && c(l);
        !1 === this._event("preSubmit",
            [l, s]) ? this._processing(!1) : (this.s.ajax || this.s.ajaxUrl ? this._ajax : this._submitTable).call(this, l, function (c, d) {
            g._submitSuccess(c, d, l, v, s, p, f, a, b)
        }, function (a, c, f) {
            g._submitError(a, c, f, b, l)
        })
    };
    e.prototype._submitTable = function (a, b) {
        var c = a.action, f = {data: []}, g = u.ext.oApi._fnSetObjectDataFn(this.s.idSrc);
        if ("remove" !== c) {
            var e = this._dataSource("fields", this.modifier());
            d.each(a.data, function (a, b) {
                var h = d.extend(!0, {}, e[a].data, b);
    ...
    e.prototype._submitSuccess =
        function (a, b, c, f, g, e, j, o, i) {
            var l = this, s, p = this.s.fields, m = this.s.editOpts, n = this.s.modifier;
            ...
            if (b || a.error || a.fieldErrors.length) this.error(a.error), d.each(a.fieldErrors, function (a, b) {
                ...
                if (a === 0) if (m.onFieldError === "focus") {
                    d(l.dom.bodyContent, l.s.wrapper).animate({scrollTop: d(c.node()).position().top}, 500);
                    c.focus()
                } else if (typeof m.onFieldError ===
                    "function") m.onFieldError(l, b)
            }), i && i.call(l, a); else {
                b = {};
                if (a.data && ("create" === g || "edit" === g)) {
                    this._dataSource("prep", g, n, f, a, b);
                    for (f = 0; f < a.data.length; f++) s = a.data[f], this._event("setData", [a, s, g]), "create" === g ? (this._event("preCreate", [a, s]), this._dataSource("create", p, s, b), this._event(["create", "postCreate"], [a, s])) : "edit" === g && (this._event("preEdit", [a, s]), this._dataSource("edit", n, p, s, b), this._event(["edit", "postEdit"], [a, s]));
                    this._dataSource("commit", g, n, a.data, b)
                } else "remove" === g && (this._dataSource("prep",
                    g, n, f, a, b), this._event("preRemove", [a]), this._dataSource("remove", n, p, b), this._event(["remove", "postRemove"], [a]), this._dataSource("commit", g, n, a.data, b));
                if (e === this.s.editCount) if (this.s.action = null, "close" === m.onComplete && (j === h || j)) this._close(a.data ? !0 : !1); else if ("function" === typeof m.onComplete) m.onComplete(this);
                o && o.call(l, a);
                this._event("submitSuccess", [a, s])
            }
            this._processing(!1);
            this._event("submitComplete", [a, s])
        };
    e.prototype._submitError = function (a, b, c, f, d) {
        this._event("postSubmit", [a,
            b, c, d]);
    ...
    e.prototype._tidy = function (a) {
        var b = this, c = this.s.table ? new d.fn.dataTable.Api(this.s.table) : null, f = !1;
        c && (f = c.settings()[0].oFeatures.bServerSide);
        return this.s.processing ? (this.one("submitComplete", function () {
            if (f) c.one("draw", a); else setTimeout(function () {
                a()
            }, 10)
        }), !0) : "inline" === this.display() || "bubble" === this.display() ? (this.one("close", function () {
            if (b.s.processing) b.one("submitComplete",
                function (b, d) {
                    if (f && d) c.one("draw", a); else setTimeout(function () {
                        a()
                    }, 10)
    ...
    e.defaults = {
        ...
        i18n: {
            ...
            remove: {
                ...
                title: "Delete",
                submit: "Delete",
                confirm: {_: "Are you sure you wish to delete %d rows?", 1: "Are you sure you wish to delete 1 row?"}
            },
            error: {system: 'A system error has occurred (<a target="_blank" href="//datatables.net/tn/12">More information</a>).'},
            multi: {
        ...
        formOptions: {
            ...
            inline: d.extend({}, e.models.formOptions, {buttons: !1, submit: "changed"}),
    ...
    var N = function (a, b, c) {
        ...
        E = function (a, b) {
            var c = "keyless" === a ? l : d('[data-editor-id="' + a + '"]');
            return d('[data-editor-field="' + b + '"]', c)
        }, F = e.dataSources = {}, G = function (a, b) {
            ...
            b.rows(c).indexes().each(function (c) {
                var c = b.row(c),
                    j = c.data(), o = d(j);
                o === h && e.error("Unable to find row identifier", 14);
                a[o] = {idSrc: o, data: j, node: c.node(), fields: f, type: "row"}
            })
        }, I = function (a, b, c, f, g, k) {
            b.cells(c).indexes().each(function (j) {
                var o = b.cell(j), i = b.row(j.row).data(), i = g(i), l;
                if (!(l = k)) {
                    l = j.column;
                    l = b.settings()[0].aoColumns[l];
                    var s = l.editField !== h ? l.editField : l.mData, m = {};
                    d.each(f, function (a, b) {
                        if (d.isArray(s)) for (var c = 0; c < s.length; c++) {
                            var f = b, e = s[c];
                            f.dataSrc() === e && (m[f.name()] = f)
                        } else b.dataSrc() === s && (m[b.name()] = b)
                    });
                    d.isEmptyObject(m) &&
                    e.error("Unable to automatically determine field from source. Please specify the field name.", 11);
                    l = m
                }
                var n = "object" === typeof c && c.nodeName || c instanceof d;
                H(a, b, j.row, f, g);
                a[i].attach = n ? [d(c).get(0)] : [o.node()];
                a[i].displayFields = l
            })
        }, P = function (a) {
    ...
    F.dataTable = {
        individual: function (a, b) {
            var c = u.ext.oApi._fnGetObjectDataFn(this.s.idSrc), f = d(this.s.table).DataTable(), e = this.s.fields,
                k = {}, j;
            b && (d.isArray(b) || (b = [b]), j = {}, d.each(b,
                function (a, b) {
                    j[b] = e[b]
                }));
            I(k, f, a, e, c, j);
            ...
            var b = u.ext.oApi._fnGetObjectDataFn(this.s.idSrc), c = d(this.s.table).DataTable(), f = this.s.fields,
                e = {};
            d.isPlainObject(a) && (a.rows !== h || a.columns !== h || a.cells !== h) ? (a.rows !== h && H(e, c, a.rows, f, b), a.columns !== h && c.cells(null, a.columns).indexes().each(function (a) {
                I(e, c, a, f, b)
            }), a.cells !== h && I(e, c, a.cells, f, b)) : H(e, c, a, f, b);
            return e
        }, create: function (a, b) {
            var c = d(this.s.table).DataTable();
            G(c, this) || (c = c.row.add(b), O(c.node()))
        }, edit: function (a,
                           b, c, f) {
            b = d(this.s.table).DataTable();
            if (!G(b, this)) {
                var e = u.ext.oApi._fnGetObjectDataFn(this.s.idSrc), k = e(c), a = b.row(P(k));
                a.any() || (a = b.row(function (a, b) {
                    return k == e(b)
                }));
                a.any() ? (a.data(c), c = d.inArray(k, f.rowIds), f.rowIds.splice(c, 1)) : a = b.row.add(c);
                O(a.node())
            }
        }, remove: function (a, b, c) {
            var b = d(this.s.table).DataTable(), f = c.cancelled;
            if (!G(b, this)) if (0 === f.length) b.rows(a).remove(); else {
                var e = u.ext.oApi._fnGetObjectDataFn(this.s.idSrc), k = [];
            ...
            b = d(this.s.table).DataTable();
            if ("edit" === a && f.rowIds.length) for (var e = f.rowIds, k = u.ext.oApi._fnGetObjectDataFn(this.s.idSrc), j = 0, f = e.length; j < f; j++) a = b.row(P(e[j])), a.any() || (a = b.row(function (a, b) {
                return e[j] === k(b)
            })),
            a.any() && a.remove();
    ...
    F.html = {
        initField: function (a) {
            ...
            var f = F.html.fields.call(this, a), e = this.s.fields, k = {};
            d.each(b, function (a, b) {
                k[b] = e[b]
            });
            d.each(f, function (f, h) {
                ...
                if (c) i = d(c); else {
                    i = a;
                    for (var l = b, m = d(), n = 0, p = l.length; n < p; n++) m = m.add(E(i, l[n]));
                    i = m.toArray()
                }
                h.attach = i;
                h.fields = e;
            ...
            b[a] = {idSrc: a, data: c, node: l, fields: f, type: "row"};
            return b
        }, create: function (a, b) {
            if (b) {
                var c = u.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(b);
                d('[data-editor-id="' + c + '"]').length && N(c, a, b)
            }
        }, edit: function (a, b, c) {
            a = u.ext.oApi._fnGetObjectDataFn(this.s.idSrc)(c) || "keyless";
            N(a, b, c)
        }, remove: function (a) {
    ...
    u.TableTools &&
    (n = u.TableTools.BUTTONS, C = {
        sButtonText: null,
        editor: null,
        formTitle: null
    }, n.editor_create = d.extend(!0, n.text, C, {
        formButtons: [{
            label: null, fn: function () {
                this.submit()
            }
        }], fnClick: function (a, b) {
            var c = b.editor, f = c.i18n.create, d = b.formButtons;
            if (!d[0].label) d[0].label = f.submit;
            c.create({title: f.title, buttons: d})
        }
    }), n.editor_edit = d.extend(!0, n.select_single, C, {
        formButtons: [{
            label: null, fn: function () {
                this.submit()
            }
            ...
            if (c.length === 1) {
                var f = b.editor, d = f.i18n.edit,
                    e = b.formButtons;
                if (!e[0].label) e[0].label = d.submit;
                f.edit(c[0], {title: d.title, buttons: e})
            }
        }
    }), n.editor_remove = d.extend(!0, n.select, C, {
        question: null, formButtons: [{
            ...
            var c = this.fnGetSelectedIndexes();
            if (c.length !== 0) {
                var f = b.editor, d = f.i18n.remove, e = b.formButtons,
                    h = typeof d.confirm === "string" ? d.confirm : d.confirm[c.length] ?
                        d.confirm[c.length] : d.confirm._;
                if (!e[0].label) e[0].label = d.submit;
                f.remove(c, {message: h.replace(/%d/g, c.length), title: d.title, buttons: e})
            }
        }
    }));
    n = u.ext.buttons;
    d.extend(n, {
        create: {
            text: function (a, b, c) {
                ...
                a = f.editor;
                a.create({
                    buttons: f.formButtons, message: f.formMessage,
            ...
            extend: "selected", text: function (a, b, c) {
                ...
                var a = f.editor, c = b.rows({selected: true}).indexes(), d = b.columns({selected: true}).indexes(),
                    b = b.cells({selected: true}).indexes();
            ...
            extend: "selected", text: function (a, b, c) {
                ...
                var c = b.rows({selected: true}).indexes(), d = a.i18n.remove;
                return (typeof d.confirm === "string" ? d.confirm : d.confirm[c.length] ? d.confirm[c.length] : d.confirm._).replace(/%d/g,
                    c.length)
            }, formTitle: null, action: function (a, b, c, d) {
                a = d.editor;
                a.remove(b.rows({selected: true}).indexes(), {
    ...
    e.DateTime = function (a, b) {
        this.c = d.extend(true, {}, e.DateTime.defaults, b);
        var c = this.c.classPrefix, f = this.c.i18n;
        if (!q.moment && this.c.format !== "YYYY-MM-DD") throw"Editor datetime: Without momentjs only the format 'YYYY-MM-DD' can be used";
        var g = function (a) {
                return '<div class="' + c + '-timeblock"><div class="' + c + '-iconUp"><button>' + f.previous + '</button></div><div class="' + c + '-label"><span/><select class="' + c + "-" + a + '"/></div><div class="' + c + '-iconDown"><button>' + f.next + "</button></div></div>"
            },
            g = d('<div class="' + c + '"><div class="' + c + '-date"><div class="' + c + '-title"><div class="' + c + '-iconLeft"><button>' + f.previous + '</button></div><div class="' + c + '-iconRight"><button>' + f.next + '</button></div><div class="' + c + '-label"><span/><select class="' +
                c + '-month"/></div><div class="' + c + '-label"><span/><select class="' + c + '-year"/></div></div><div class="' + c + '-calendar"/></div><div class="' + c + '-time">' + g("hours") + "<span>:</span>" + g("minutes") + "<span>:</span>" + g("seconds") + g("ampm") + '</div><div class="' + c + '-error"/></div>');
        this.dom = {
            container: g,
            date: g.find("." + c + "-date"),
        ...
        this.s = {
            d: null,
            display: null,
            namespace: "editor-dateime-" +
                e.DateTime._instance++,
            parts: {
    ...
    d.extend(e.DateTime.prototype, {
        ...
        errorMsg: function (a) {
            ...
            if (a instanceof Date) this.s.d = this._dateToUtc(a); else if (a === null || a === "") this.s.d = null; else if (typeof a === "string") if (q.moment) {
                var c = q.moment.utc(a,
                    this.c.format, this.c.momentLocale, this.c.momentStrict);
            ...
            var a = this, b = this.c.classPrefix, c = this.c.i18n, f = this.c.onChange;
            this.s.parts.date ||
            ...
            this.dom.container.on("change", "select", function () {
                ...
                if (e !== "select") {
                    ...
                    if (e === "button") {
                        c = d(c.target);
                        e = c.parent();
                        if (!e.hasClass("disabled")) if (e.hasClass(b + "-iconLeft")) {
            ...
            var c = this._daysInMonth(a.getUTCFullYear(), b), d = a.getUTCDate() > c;
            a.setUTCMonth(b);
            if (d) {
                a.setUTCDate(c);
                a.setUTCMonth(b)
            ...
            var b = ["day"], c = this.c.classPrefix;
            ...
            var c = this._dateToUtc(new Date), f = this._daysInMonth(a, b),
                e = (new Date(Date.UTC(a, b, 1))).getUTCDay(), h = [], j = [];
            if (this.c.firstDay > 0) {
                e = e - this.c.firstDay;
                e < 0 && (e = e + 7)
            }
            for (var i = f + e, l = i; l > 7;) l = l - 7;
            var i = i + (7 - l), l = this.c.minDate, m =
                this.c.maxDate;
            if (l) {
                l.setUTCHours(0);
                l.setUTCMinutes(0);
            ...
            for (var n = 0, p = 0; n < i; n++) {
                var q = new Date(Date.UTC(a, b, 1 + (n - e))), t = this.s.d ? this._compareDates(q, this.s.d) : false,
                    u = this._compareDates(q, c), v = n < e || n >= f + e, w = l && q < l || m && q > m,
                    x = this.c.disableDays;
                d.isArray(x) && d.inArray(q.getUTCDay(), x) !== -1 ? w = true : typeof x === "function" && x(q) === true && (w = true);
            ...
            var a = [], b = this.c.firstDay, c = this.c.i18n, d = function (a) {
                for (a = a + b; a >= 7;) a = a - 7;
                return c.weekdays[a]
            };
            this.c.showWeekNumber && a.push("<th></th>");
            for (var e = 0; e < 7; e++) a.push("<th>" +
                d(e) + "</th>");
            return a.join("")
            ...
            return '<td class="' + this.c.classPrefix + '-week">' + c + "</td>"
        }, _options: function (a, b, c) {
            c || (c = b);
            a = this.dom.container.find("select." + this.c.classPrefix + "-" + a);
            a.empty();
            for (var d = 0, e = b.length; d < e; d++) a.append('<option value="' + b[d] + '">' + c[d] + "</option>")
        }, _optionSet: function (a, b) {
            var c = this.dom.container.find("select." + this.c.classPrefix +
                "-" + a), d = c.parent().children("span");
            c.val(b);
            c = c.find("option:selected");
            d.html(c.length !== 0 ? c.text() : this.c.i18n.unknown)
        }, _optionsTime: function (a, b, c) {
            var a = this.dom.container.find("select." + this.c.classPrefix + "-" + a), d = 0, e = b,
                h = b === 12 ? function (a) {
                    return a
                } : this._pad;
            if (b === 12) {
            ...
            for (b = d; b < e; b = b + c) a.append('<option value="' + b + '">' + h(b) + "</option>")
        }, _optionsTitle: function () {
            var a = this.c.i18n, b = this.c.minDate, c = this.c.maxDate, b = b ? b.getFullYear() : null,
                c = c ? c.getFullYear() : null, b = b !== null ? b : (new Date).getFullYear() -
                this.c.yearRange, c = c !== null ? c : (new Date).getFullYear() + this.c.yearRange;
            this._options("month", this._range(0, 11), a.months);
            this._options("year", this._range(b, c))
        }, _pad: function (a) {
            return a < 10 ? "0" + a : a
        }, _position: function () {
            var a = this.dom.input.offset(), b = this.dom.container, c = this.dom.input.outerHeight();
            b.css({top: a.top + c, left: a.left}).appendTo("body");
            var f = b.outerHeight(), e = d("body").scrollTop();
            if (a.top + c + f - e > d(q).height()) {
                a = a.top - f;
                b.css("top", a < 0 ? 0 : a)
            }
        }, _range: function (a, b) {
            ...
            } else this._optionSet("hours",
                b);
            this._optionSet("minutes", a ? a.getUTCMinutes() : 0);
            this._optionSet("seconds", a ? a.getSeconds() : 0)
        }, _show: function () {
            var a = this, b = this.s.namespace;
            this._position();
            d(q).on("scroll." + b + " resize." + b, function () {
                a._position()
            });
            d("div.DTE_Body_Content").on("scroll." + b, function () {
                a._position()
            });
            d(l).on("keydown." + b, function (b) {
                (b.keyCode === 9 || b.keyCode === 27 || b.keyCode === 13) && a._hide()
            });
            setTimeout(function () {
                d("body").on("click." + b, function (b) {
                    !d(b.target).parents().filter(a.dom.container).length && b.target !==
                    a.dom.input[0] && a._hide()
                })
            }, 10)
        }, _writeOutput: function (a) {
            var b = this.s.d,
                b = q.moment ? q.moment.utc(b, h, this.c.momentLocale, this.c.momentStrict).format(this.c.format) : b.getUTCFullYear() + "-" + this._pad(b.getUTCMonth() + 1) + "-" + this._pad(b.getUTCDate());
    ...
    var J = function (a, b) {
            if (b === null || b === h) b = a.uploadText || "Choose file...";
            ...
            b._enabled = true;
            J(b);
            if (q.FileReader && b.dragDrop !== false) {
                ...
                a.on("open", function () {
                    d("body").on("dragover.DTE_Upload drop.DTE_Upload",
                        function () {
                            return false
                        })
                }).on("close", function () {
        ...
        n = d.extend(!0, {}, e.models.fieldType, {
            get: function (a) {
                return a._input.val()
            }, set: function (a, b) {
                a._input.val(b);
    ...
    v.readonly = d.extend(!0, {}, n, {
        create: function (a) {
            a._input = d("<input/>").attr(d.extend({
                id: e.safeId(a.id), type: "text",
                readonly: "readonly"
            }, a.attr || {}));
            return a._input[0]
        }
    ...
    v.text = d.extend(!0, {}, n, {
        create: function (a) {
            a._input = d("<input/>").attr(d.extend({id: e.safeId(a.id), type: "text"}, a.attr || {}));
            return a._input[0]
        }
    });
    v.password = d.extend(!0, {}, n, {
        create: function (a) {
            a._input = d("<input/>").attr(d.extend({id: e.safeId(a.id), type: "password"}, a.attr || {}));
            return a._input[0]
        }
    });
    v.textarea = d.extend(!0, {}, n, {
        create: function (a) {
            a._input = d("<textarea/>").attr(d.extend({id: e.safeId(a.id)}, a.attr || {}));
            return a._input[0]
        },
        canReturnSubmit: function () {
            return false
    ...
    v.select = d.extend(!0, {}, n, {
        _addOptions: function (a, b, c) {
            var d = a._input[0].options, g = 0;
            if (c) g = d.length; else {
                d.length = 0;
                if (a.placeholder !== h) {
            ...
            a._input = d("<select/>").attr(d.extend({
                ...
                if (!c || !c.editor) a._lastSet = v.select.get(a)
            });
            v.select._addOptions(a, a.options || a.ipOpts);
            return a._input[0]
        }, update: function (a, b, c) {
            v.select._addOptions(a, b, c);
            b = a._lastSet;
            b !== h && v.select.set(a, b, true);
            B(a._input)
        }, get: function (a) {
            ...
            a._input.find("option").each(function () {
                h = false;
                for (f = 0; f < e; f++) if (this._editor_val == b[f]) {
                    j = h = true;
                    break
                }
                this.selected = h
            });
            if (a.placeholder && !j && !a.multiple && i.length) i[0].selected = true;
            c || B(a._input);
            return j
        }, destroy: function (a) {
    ...
    v.checkbox = d.extend(!0, {}, n, {
        _addOptions: function (a, b, c) {
            var f = a._input, g = 0;
            c ? g = d("input", f).length :
                f.empty();
            b && e.pairs(b, a.optionsPair, function (b, c, h) {
                f.append('<div><input id="' + e.safeId(a.id) + "_" + (h + g) + '" type="checkbox" /><label for="' + e.safeId(a.id) + "_" + (h + g) + '">' + c + "</label></div>");
            ...
            var b = [], c = a._input.find("input:checked");
            ...
            var d = v.checkbox, e = d.get(a);
            d._addOptions(a, b, c);
            d.set(a, e)
        }
    });
    v.radio = d.extend(!0, {}, n, {
        _addOptions: function (a, b, c) {
            var f = a._input, g = 0;
            c ? g = d("input", f).length : f.empty();
            b && e.pairs(b, a.optionsPair, function (b, c, h) {
                f.append('<div><input id="' + e.safeId(a.id) + "_" + (h + g) + '" type="radio" name="' + a.name + '" /><label for="' + e.safeId(a.id) + "_" + (h + g) + '">' + c + "</label></div>");
                d("input:last", f).attr("value", b)[0]._editor_val = b
            })
        }, create: function (a) {
            a._input = d("<div />");
            v.radio._addOptions(a, a.options || a.ipOpts);
            this.on("open", function () {
                a._input.find("input").each(function () {
                    if (this._preChecked) this.checked =
                        true
                })
            });
            return a._input[0]
            ...
            a._input.find("input").each(function () {
                ...
                if (this._editor_val == b) this._preChecked = this.checked = true; else this._preChecked = this.checked = false
            });
            ...
            d.set(a, b.filter('[value="' + e + '"]').length ? e : b.eq(0).attr("value"))
        }
    });
    v.date = d.extend(!0, {}, n, {
        create: function (a) {
            ...
            if (d.datepicker) {
                ...
                setTimeout(function () {
                    ...
                    d("#ui-datepicker-div").css("display",
                        "none")
                }, 10)
            ...
            return d(b).parents("div.ui-datepicker").length || d(b).parents("div.ui-datepicker-header").length ?
                true : false
        }
    });
    v.datetime = d.extend(!0, {}, n, {
        create: function (a) {
            a._input = d("<input />").attr(d.extend(true, {id: e.safeId(a.id), type: "text"}, a.attr));
    ...
    v.uploadMany = d.extend(!0, {}, n, {
        create: function (a) {
            var b = this, c = Q(b, a, function (c) {
                a._val = a._val.concat(c);
                e.fieldTypes.uploadMany.set.call(b,
                    a, a._val)
            });
            ...
            a._val = b;
            var c = this, e = a._input;
            if (a.display) {
                e = e.find("div.rendered").empty();
                if (b.length) {
                    var g = d("<ul/>").appendTo(e);
                    d.each(b, function (b, d) {
                        g.append("<li>" + a.display(d, b) + ' <button class="' +
                            c.classes.form.button + ' remove" data-idx="' + b + '">&times;</button></li>')
                    })
    ...
    u.ext.editorFields && d.extend(e.fieldTypes, u.ext.editorFields);
    u.ext.editorFields = e.fieldTypes;
    e.files = {};
...
(function (c) {
    ...
    e.create.title = "<h4>" + e.create.title + "</h4>";
    e.edit.title = "<h4>" + e.edit.title + "</h4>";
    e.remove.title = "<h4>" + e.remove.title + "</h4>";
    ...
    c.extend(!0, c.fn.dataTable.Editor.classes, {
        ...
        form: {tag: "form-horizontal", button: "btn btn-success"},
        field: {
            wrapper: "DTE_Field form-group",
            label: "col-lg-12 control-label",
            input: "col-lg-12 controls",
